    ...
    <div class="ea-container">
        ...
        <div class="ea-header">
            ...
            <div class="ea-controls">
                ...
                <button v-if="config.canManage" @click="exportData" class="ea-btn ea-btn-success">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div v-if="showSettings" class="ea-card">
            ...
            <div class="ea-grid ea-grid-cols-2 ea-gap-8">
                <div class="ea-space-y-4">
                    ...
                    <button v-if="config.canManage" @click="resetGeoStats" :disabled="resetting" class="ea-btn ea-btn-primary ea-mt-4">
